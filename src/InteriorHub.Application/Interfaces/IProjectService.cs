...
public interface IProjectService
{
    ...
    Task<ProjectReadDto> GetMyProjectByIdAsync(int engineerId, int id, CancellationToken cancellationToken = default);
    ...
    Task<IReadOnlyList<ProjectImageReadDto>> GetProjectImagesAsync(int engineerId, int projectId, CancellationToken cancellationToken = default);
    Task UpdateImageDisplayOrderAsync(int engineerId, int projectId, int imageId, int displayOrder, CancellationToken cancellationToken = default);
